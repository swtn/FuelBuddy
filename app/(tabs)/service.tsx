          ...
          {isEditing ? (
            <View style={styles.form}>
              ...
              <TextInput
                ...
                onChangeText={(val) =>
                  setTempInfo({ ...tempInfo, nextServiceKm: Number(val) || 0 })
                }
              />
              <Text style={styles.label}>
                Licznik przy ostatniej wymianie oleju:
              </Text>
              <TextInput
                style={styles.input}
                keyboardType="numeric"
                ...
                onChangeText={(val) =>
                  setTempInfo({
                    ...tempInfo,
                    lastOilChangeKm: Number(val) || 0,
                  })
                }
              />
              <Text style={styles.label}>
                Data ważności przeglądu (RRRR-MM-DD):
              </Text>
              <TextInput
                style={styles.input}
                value={tempInfo.techReviewDate}
                onChangeText={(val) =>
                  setTempInfo({ ...tempInfo, techReviewDate: val })
                }
              />
